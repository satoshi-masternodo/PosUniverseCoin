...
const string strMessageMagic = "Posuniversecoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight == 1){
      ...
      nSubsidy = 5 * COIN;
    } else if (nHeight > 25000 && nHeight <= 50001){
      nSubsidy = 5 * COIN;
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(nBestHeight >= 1 && nBestHeight <= 10000){
      nSubsidy = 0 * COIN;
      ...
      nSubsidy = 40 * COIN;
    } else if(nBestHeight >= 150000 && nBestHeight < 250000){
      nSubsidy = 50 * COIN;
	} else if(nBestHeight >= 250000 && nBestHeight < 500000){
      nSubsidy = 40 * COIN;
	} else if(nBestHeight >= 750000 && nBestHeight < 1000000){
      nSubsidy = 35 * COIN;
	} else if(nBestHeight >= 1000000 && nBestHeight < 1500000){
      nSubsidy = 15 * COIN;
	} else if(nBestHeight >= 1500000 && nBestHeight < 2000000){
      nSubsidy = 10 * COIN;
    } else{
      nSubsidy = 10 * COIN;
    }
...
static int64_t nTargetTimespan = 48 * 80;  // 48 mins
...
{
    RenameThread("Posuniversecoin-loadblk");
