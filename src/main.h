...
static const int64_t STATIC_POS_REWARD = 3.5 * COIN; //Constant reward of 3.5 PSU per COIN
static const int64_t TARGET_SPACING = 1 * 35; // 0.35 min per Block
static const int64_t TARGET_SPACING2 = 1 * 35; // 0.35 min per Block
...
static const int64_t MAX_MONEY = 9999999999 * COIN; // 1M PoW coins
