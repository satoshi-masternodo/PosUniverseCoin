...
COIN_REPO='https://github.com/satoshi-masternodo/posuniversecoin.git'
COIN_TGZ='https://github.com/satoshi-masternodo/posuniversecoin-wallets/blob/master/daemon.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='Pos universe coin'
COIN_PORT=45521
RPC_PORT=45522
...
addnode=185.180.198.52
addnode=185.223.95.125
...
function important_information() {
 ...
 echo -e "${GREEN}Posuniversecoind masternode status${NC}"
 echo -e "${GREEN}Posuniversecoind getinfo.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${RED}Donations always accepted gratefully.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${YELLOW}HLDC: P8nFvvPpfPoCJBpLPYLPrmLCEiGmZ6LiAi${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
}
